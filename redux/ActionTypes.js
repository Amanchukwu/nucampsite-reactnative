//Has all the possible action objects that we can dispatch to reducers to let the app know the current state, including when we are loading data, adding data, and when the fetching of data has failed 
...
export const DELETE_FAVORITE = 'DELETE_FAVORITE'; //Added to support swipe-to-delete on favorites list